...
class LoginController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        setupUI()
        joinButton.addTarget(self, action: #selector(didTapLoginButton), for: .touchUpInside)
    ...
    func setupUI() {
        ...
        subtitleLabel.text = "green's waiting for you"
        ...
        formTitleLabel.text = "Login Account"
        ...
        // Form alanları
        let fields = ["Email or Phone Number", "Password"]
